package cainarong.snru.ac.th.emercall.utility;
...
public class HopitaAdpter extends BaseAdapter{
    //    Explicit
    private Context context;
    private int[] ints;
    private String[] titleStrings, phoneStrings;

    public HopitaAdpter(Context context, int[] ints, String[] titleStrings, String[] phoneStrings) {
